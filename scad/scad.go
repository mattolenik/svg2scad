...
const SupportingFile = `// CODEGEN: This file was GENERATED by svg2scad and SHOULD NOT BE MODIFIED by hand.

// extents finds the bounding box of a set of 2D coordinates
